...
def run_inference(image_path: str, conf_threshold: float = 0.60, with_visualization: bool = False):
    """
    ...
    results = model.predict(source=image_path, conf=conf_threshold,iou=0.55, save=False, verbose=False)
